<?php
  ...
  $title = "Administrator Hotel | Detail Kamar";
        ...
        <div class="dashboard-wrapper">
            <div class="container-fluid dashboard-content">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Detail Jenis Kamar </h2>
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Detail Jenis Kamar</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h5 class="card-header">Detail Jenis Kamar</h5>
                            <div class="card-body">
                                <form method="post" action="up_j_kamar.php" enctype="multipart/form-data">
                                    <div class="form-group">
                                      ...
                                      <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="nama" disabled value="<?php echo $data['nama_tipe']; ?>">
                                      </div>
                                      <div class="form-group">
                                        <label>Deskripsi</label>
                                        <textarea class="form-control" row="3" disabled name="des"><?php echo $data['deskripsi']; ?></textarea>
                                      </div>
                                      <div class="form-group">
                                          <label>Tarif</label>
                                          <input type="number" class="form-control" disabled name="tarif" value="<?php echo $data['tarif']; ?>">
                                      </div>
                                      <div class="form-group">
                                          <label>Foto</label>
                                      ...
                                      <div class="form-group">
                                          <label>Tarif</label>
                                          <input type="number" class="form-control" disabled name="total" value="<?php echo $data['kamar_tersedia']; ?>">
                                      </div>
                            </div>
                          </form>
                        </div>
